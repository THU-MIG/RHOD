...
def read_image(file_name, format=None):
    ...
    if not os.path.exists(file_name):
        ...
        file_name = file_name.replace(str(int(img_id)), str(int(img_id)+1))
...
#         expected_hw = (dataset_dict["height"], dataset_dict["width"])
#         if image_wh == expected_hw:
#             expected_wh = expected_hw
#             dataset_dict["width"], dataset_dict["height"] = expected_hw
        if image_wh != expected_wh:
            expected_wh = image_wh
            dataset_dict["width"], dataset_dict["height"] = image_wh

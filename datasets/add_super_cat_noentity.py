...
for key in map_super_cat.keys():
    if map_super_cat[key] == 'entity':
        map_super_cat[key] = key
...
with open('annotations-expanded-v4-full-path-noentity-addarea-strid-attr-supercat2.json', 'w') as f:
    json.dump(a, f)
